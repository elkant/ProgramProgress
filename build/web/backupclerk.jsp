<%-- 
    Document   : backupclerk
    Created on : Mar 19, 2014, 9:26:47 AM
    Author     : Maureen
--%>
...
//                session.removeAttribute("Location");
    ...
    %>
                ...
                <form  action="Back_up_SQLClerk"  style="margin-left: 200px; margin-right: 100px;margin-top: 100px; height: 110px; width: 700px; background-color: #F5F5F5;">
