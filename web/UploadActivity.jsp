<%-- 
    Document   : UploadActivity
    Created on : Mar 17, 2014, 10:35:31 AM
    Author     : Maureen
--%>
...
//                xmlhttp.open("POST","UploadSQLData?fname="+name,true);
//                xmlhttp.send();
...
<!--              </div>-->
        ...
        <%if (session.getAttribute("replyback") != null) { %>
                    ...
                    var n1 = noty({text: '<%=session.getAttribute("replyback")%>',
                        layout: 'center',
                        type: 'Success',
                ...
                session.removeAttribute("replyback");
                        ...
                        %> 
                <form action="UploadSQLData"  method="post" enctype="multipart/form-data"  style="margin-left:300px; margin-right: 100px;margin-top: 100px; height: 210px; width: 700px; background-color: #F5F5F5;">   
...
<!--                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="file" style="width:350px;" name="filename" id="fname" /></td>
