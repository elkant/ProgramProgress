<%-- 
    Document   : Baseline2Maintain
    Created on : Sep 16, 2013, 2:37:24 PM
    Author     : Maureen
--%>
		...
		<script type="text/javascript">
			$(document).ready( function () {
				$('#example').dataTable().makeEditable({
                                                                        ...
                                                                        sUpdateURL: "UpdateBaselines2",
                                                                        sAddURL: "AddCounty",
                                                                        sDeleteURL: "DeleteBaselines2",
                    							"aoColumns": [ null,                  									
...
<table cellpadding="0" style="padding-top: 100px;" cellspacing="0" border="0" class="display" id="example">
   ...
   <tbody>
        ...
        <c:forEach  var="baselines" items="${baseline}"  >
          ...
          <c:set var="QtargetTotal"  value="${baselines.QTARGETTOTAL}"></c:set>
         
          <c:set var="BaselineTotal"  value="${baselines.BASELINETOTAL}"></c:set>
          <c:set var="endTargetTotal"  value="${baselines.ENDTARGETTOTAL}"></c:set>
       ...
       <input type="hidden" id="District" name="District" value="<%= pageContext.getAttribute("District")%>" />
           ...
           <td class="sorting_1">${baselines.QTARGETTOTAL} </td>
           <td class="sorting_1">${baselines.BASELINETOTAL} </td>
           <td class="sorting_1">${baselines.ENDTARGETTOTAL} </td>
