<%-- 
    Document   : UploadActivityData
    Created on : Mar 17, 2014, 4:02:00 PM
    Author     : Maureen
--%>
...
<script type="text/javascript">
            ...
            function uploadfile(){
                ...
                xmlhttp.open("POST","ReadCSV?fname="+name,true);
                xmlhttp.send();
...
<!--              </div>-->
            ...
            <!--<div id="content" style="width:1020px;">-->
                ...
                <form action="ReadCSV"  method="post"  style="margin-left: 400px; margin-right: 100px;margin-top: 100px; height: 210px;">   
