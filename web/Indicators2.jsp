<%-- 
    Document   : Indicators2
    Created on : Sep 14, 2013, 6:26:05 PM
    Author     : Maureen
--%>
...
<div id="container" style="width:1000px; border-radius:25px; padding-top: 20px;padding-bottom: 20px; padding-left:20px; padding-right:20px;padding-top: 100px; margin-left:150px; ">
<!--            This is the login page-->

       
                        <h4>INDICATOR ACTIVITIES</h4>
                        <form name="frm" id="frm" method="post"  action="indicatoractivities1">
