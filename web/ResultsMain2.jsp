...
//document.getElementById('activityOthers'+b).style.visibility = "hidden";
//document.getElementById('activityOthers'+b).style.display = "none";
...
//            element4.id = 'new_activity_'+k;
                                 var cell4 = row.insertCell(3);
             cell4.innerHTML="<select id='new_activity_"+k+"' required='true' name='new_activity_"+j+"' style='width:140px;' value='' onchange='new_changer("+k+")'>"
...
//            cell4.appendChild(element4);
            ...
            var cell4 = row.insertCell(3);
             cell4.innerHTML="<select id='new_activity_"+i+"' required='true' name='new_activity_"+t+"' style='width:140px;' value='' onchange='new_changer("+i+")'>"
 ...
 function addResultRow(tableID) {
  ...
  var table = document.getElementById(tableID);
   ...
   var cell1 = row.insertCell(0);
                ...
                var option;
 <% 
  Querys= "SELECT countyName,countyID FROM county";
  option4="";
...
//            cell8.appendChild(element8);
             ...
             var cell8 = row.insertCell(2);
             cell8.innerHTML="<input type=text id='new_achievedw_"+p+"' required='true' name='new_achievedw_"+p+"' style='width:140px;' value='' onblur='validateWomen("+p+")'>"
...
//            cell9.appendChild(element9);
         ...
         var cell9 = row.insertCell(3)
             cell9.innerHTML="<input type=text id='new_achievedm_"+p+"' required='true' name='new_achievedm_"+p+"' style='width:140px;' value='' onblur='validateMen("+p+")'>"
...
<!--                  <a class="button-1" href="index.jsp">Login</a>-->
   ...
   <table class="fixed" style="margin-top: 100px; margin-left:40px; ">
...
<tr id="dialog1" title=" ">
    ...
    <td>
         ...
         <%}%>
                             ...
                             <tr><th style="width:300px">  <a href="#" id="dialog-link1" style="padding-right: 0px;">
                                 ...
                                 <Th><select name=""  id="title" data-placeholder="Choose an indicator..."  style="width:600px;"  onchange="resetSeparate();resetCombined();filterID(this);filtersID(this);" required>
                   ...
                   <input name="newrows" type="hidden" id="newrows" value="0" />
                        ...
                        <table class="fixed" style="text-align: center;"> 
                            ...
                            <tr>
                                ...
                                <td><input type="button" value="Add Row" style="background-color: #1385e5; color: white;" onClick="addRow('dataTable')" onmouseover="enteryr();" /></td>
...
<!--                  <label><input type="text" id="h" value="0"/>
                              ...
                              <h4>INDICATOR RESULTS   <a href="#" id="dialog-link3" style="padding-right: 0px;">
                         ...
                         <td><input type="button" value="Delete Row" style="background-color: #c66200;" onClick="deleteResultRow('tablerow1')" /></td></tr>
                                                   ...
                                                   <table  class="fixed" id="tablerow1" style="width:1500px;">
...
<!--                       <input type="hidden" id="h1" value="0"/>-->
                                     ...
                                     <tr>  <td colspan="4"></td>
                                         <td> <input name="Submit" type="submit"  style="background-color:#1385e5;color: white; " value="Save" onmouseover="validatequarters();validateyears(); validatedates1();"/></td>
                                            <td><INPUT type="button"  style="background-color:#1385e5;color: white; " value="Add Row" onclick="addRow1('dataTable1')" onmouseover="enteryr1();" /></td>
