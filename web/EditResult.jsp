         ...
         <script type="text/javascript">
			...
			$(document).ready( function () {
				$('#example').dataTable().makeEditable({
                                                                        ...
                                                                        sUpdateURL: "UpdateResult",
//                                                                        sAddURL: "AddCounty",
                                                                        sDeleteURL: "DeleteResult",
                    							"aoColumns": [ null,null,                  									
...
<!--                    <th>Result ID</th>-->
   ...
   <tbody>
        ...
        <c:forEach  var="results" items="${result}"  >
          ...
          <c:set var="id" value="${results.RESULTID}"></c:set>
          <c:set var="titleID" value="${results.TITLEID}"></c:set>
          <c:set var="District" value="${results.DISTRICT}"></c:set>
          <c:set var="Title" value="${results.TITLEID}"></c:set>
       ...
       <input type="hidden" id="titleID" name="titleID" value="<%= pageContext.getAttribute("titleID")%>" />
            ...
            <tr id="<%=pageContext.getAttribute("id")%>">
                ...
                <td class="sorting_1">${results.COUNTY} </td>
                <td class="sorting_1">${results.DISTRICT} </td>
              
          
                
                 
                        <td class="sorting_1">${results.WOMENACHIEVED} </td>
                         <td class="sorting_1">${results.MENACHIEVED} </td>
                <td class="sorting_1">${results.FINANCIAL} </td>
                <td class="sorting_1">${results.QUARTER} </td>
