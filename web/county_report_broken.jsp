<%-- 
    Document   : county_report_broken
    Created on : Mar 2, 2015, 8:26:37 AM
    Author     : user
--%>
...
%>
   ...
   <%} else if (session.getAttribute("AccessLevel").equals("3")){%>
    ...
    <form action="county_report_broken" method="post" style="margin-top: 100px; ">
           <h3 style="text-align: center;">COUNTY QUARTERLY REPORTS(BROKEN)</h3>
...
<tr>
    ...
    <th>Quarter</th><th><select name="Quarter" required="true" id="quarter" disabled="true">
                    ...
                    <th>     <select  name="countyid"  required="true" id="countyid" multiple="true">
  <%
