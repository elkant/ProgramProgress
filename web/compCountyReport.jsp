...
if (session.getAttribute("First Quarter County Report Generated Succefully") != null) { %>
    ...
    <table class="fixed" style="padding-top: 100px;">
          <tr><th style="width:200px">INDICATOR TITLE</th>
              <Th><select required="true" name="indicator" style="width:300px" id="title" id="choose-form" onchange="filterID(this)">
...
<tr>
    <th>Financial Year</th><th><select required="true" name="FinancialYear" id="financial" required="true" onChange="filterer()">
                               ...
                               <th>Quarter</th><th><select required="true" name="Quarter" required="true" id="quarter" onChange="filterer1()">
                                       <option value="">Select F Quarter</option>
                               ...
                               <tr><th style="height:50px"style="width:200px" >County</th>
                                   ...
                                   <td><select required="true" onChange="filter_districts(this);" required="true"  name="county_0" id="county" multiple="true">
