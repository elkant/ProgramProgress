<%-- 
    Document   : set_quartely_target
    Created on : Jan 17, 2014, 11:18:19 AM
 ...
 $('select').select2();    
  ...
  function nullchecker(){
     ...
     while(i<=no_of_rws){
         ...
         var yr=document.getElementById("year"+i).value;
     if(indicator=="0,0,"+i && county!="0,"+i){
        ...
        if(yr!="0,"+i && county=="0,"+i){
          alert(" Choose the County at line : "+i)
          document.getElementById("county_id"+i).focus()
          return false;   
        }
        if(yr!="0,"+i && indicator=="0,0,"+i){
          alert(" Choose the Indicator at line : "+i)
          document.getElementById("county_id"+i).focus()
          return false;   
        }
        if(yr=="0,"+i && county!="0,"+i){
          alert(" Choose the Year at line : "+i)
          document.getElementById("county_id"+i).focus()
          return false;   
        }
        if(yr=="0,"+i && indicator!="0,0,"+i){
        ...
        if(yr!="0,"+i){ all_yrs+=yr;}
          i++; 
     
     }
if(all_county=="" && all_indic=="" && all_yrs==""){
...
// var tab2_baseline="<input type='text'  id='baseline"+row_num+"' name='baseline"+row_num+"' value='' placeholder='Total' style='width: 150px;' required='true' class='textbox'>";   
// var tab1_baseline="<input type='text'id='baseline_m"+row_num+"' name='baseline_m"+row_num+"' value='' placeholder='Men' style='width: 65px;' required='true' class='textbox'>   <input type='text'id='baseline_f"+row_num+"' name='baseline_f"+row_num+"' value='' style='width: 65px;' required='true' placeholder='Women' class='textbox'>";
...
%>
    ...
    <div style="clear:both ;margin-top: 100px;">
      <h3 style="text-align: center;">Enter the project target per Quarter for each indicator.</h3>
      <form style=" margin-left: 150px;" method="post" action="add_quartely_targets" onsubmit="return nullchecker();">
...
<input type="submit" name="sub" value="Save" class="textbox1" style="background: #cc99ff; color: #0000ff">
   ...
   <table cellpadding="2px" cellspacing="3px" border="1px" class=""  style="background: #ccccff; width: 1000px; ">
  ...
  <table cellpadding="2px" cellspacing="3px" border="1px" class="" id="tb"  style="background: #ccccff; width: 1000px;">
</table>
    <br>
<!--    <input type="submit" name="sub" value="Save" class="textbox1" style="background: #cc99ff; color: #0000ff">-->
       <br><br>     
