...
%>
   ...
   <%} else if (session.getAttribute("AccessLevel").equals("3")){%>
    ...
    <form action="insertquarterlytargets" method="post" style="margin-top: 100px; ">
           <h3 style="text-align: center;">INSERT QUARTERLY TARGETS</h3>
...
<tr>
    ...
    <th>Skip Quarter</th><th><select style="height:38px;" name="quarter" required="true" id="quarter" disabled="true">
                 ...
                 <tr>
                     <th colspan="4"><input type="submit" style="height:37px;" value="Submit" /></th>
