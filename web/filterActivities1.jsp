<%-- 
    Document   : filterActivities1
    Created on : Jan 13, 2015, 9:43:14 AM
    Author     : Maureen
--%>
...
%>
   ...
   <%} else if (session.getAttribute("AccessLevel").equals("3")){%>
    ...
    <form action="EditActivityServlet2" method="post" style="margin-top: 100px; ">
           <h3 style="text-align: center;">FILTER ACTIVITIES</h3>
                      <p style="text-align: center;">Select the fields as required then click filter.</p>
