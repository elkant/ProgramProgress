 ...
 * @author Maureen
 */
public class uploadfacility extends HttpServlet {
...
// FOR NON HIV MODULE BOOK4 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int id1 = 0, id2 = 0, id3 = 0, id4 = 0, id5 = 0, id6 = 0, id7 = 0,id8=0, year = 0;
...
String pth = "C:/PPT_UPLOADS/PPTDATA.xlsx";
      ...
      //  Sheet sheet = wb.getSheetAt(0);
        Sheet sheet = wb.getSheet("facility");
...
//            System.out.println(" last cell no = "+lastCellNo);
            ...
            for (int i = 0; i < lastCellNo; i++) {
                ...
                year = (int) cell11.getNumericCellValue();
            ...
            System.out.println("County :" + county + "District :" + district + "quarter :" + quarter + "id1 :" + id1 + "id2: " + id2 + "id3 :" + id3 + "id4 :" + id4 + "id5 :" + id5 + "id6 :" + id6 + "id7 :" + id7 + "Year :" + year);
                               if(id1>-1){
String query="";                            
String checkexistingval="Select * from indicatorachievedcombined where  district='"+district+"' and financialYear='"+year+"' and titleID='5' and reportingPeriod='"+quarter+"' ";                              
...
if(conn.rs3.next()){
  query = "update indicatorachievedcombined set totalAchieved='"+id1+"' where resultID='"+conn.rs3.getString(1)+"'";
    ...
    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                                   + "VALUES('"+uniqueid().trim()+"','"+county+"','"+district+"','"+id1+"','"+quarter+"','"+year+"','5')";  
}
            ...
            if (id2 >-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='7' and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id2 + "','" + quarter + "','" + year + "','7')";
//                              conn.state.executeUpdate(query);
                }//end of else
                System.out.println(query);
                try {
            ...
            if (id3 >-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where district='" + district + "' and financialYear='" + year + "' and titleID='9' and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id3 + "','" + quarter + "','" + year + "','9')";
//                              conn.state.executeUpdate(query);
                }
                try {
                    conn.state.executeUpdate(query);
            ...
            if (id4>-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='111'  and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id4 + "','" + quarter + "','" + year + "','111')";
                }
...
//                              conn.state.executeUpdate(query);
            ...
            if (id5>-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='13'  and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id5 + "','" + quarter + "','" + year + "','13')";
                }
                try {
                    conn.state.executeUpdate(query);
                    replyback = "<font color=\"orange\"><b>Importing completed ";
...
//                              conn.state.executeUpdate(query);
            ...
            if (id6>-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='16'  and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id6 + "','" + quarter + "','" + year + "','16')";
                }
                try {
                    conn.state.executeUpdate(query);
                    replyback = "<font color=\"orange\"><b>Importing completed ";
...
//                              conn.state.executeUpdate(query);
            ...
            if (id7>-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='26'  and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id7 + "','" + quarter + "','" + year + "','26')";
//                              conn.state.executeUpdate(query);
            ...
            if (id8>-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='57'  and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);

                if (conn.rs3.next()) {

                    query = "update indicatorachievedcombined set totalAchieved='" + id8 + "' where resultID='" + conn.rs3.getString(1) + "'";

                } else {
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id8 + "','" + quarter + "','" + year + "','57')";
//                              conn.state.executeUpdate(query);
