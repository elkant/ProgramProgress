 ...
 */
public class add_quartely_targets extends HttpServlet {
String indicator_id,county_id,district_id,year,quarter,target_men,target_women,target_combined;
int max_rows=0;
String table_type="";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       dbConnect conn= new dbConnect();
        ...
        indicator_id=county_id=district_id=year=quarter=target_men=target_women=target_combined="0";
    ...
    String    indicator=request.getParameter("indicator_id"+i);   
     String   county=request.getParameter("county_id"+i); 
        ...
        String yr=request.getParameter("year"+i);
        quarter=request.getParameter("quarter"+i);
...
//       CHECK AND INSERT TO THE DATABASE.............................
   String check_existence="SELECT * FROM quartely_targets WHERE county_id='"+county_id+"' && district_id='"+district_id+"' && indicator_id='"+indicator_id+"' && year='"+year+"' && quarter='"+quarter+"'";  
      conn.rs=conn.state.executeQuery(check_existence);
      if(conn.rs.next()==false){
      String inserter="INSERT INTO quartely_targets SET county_id='"+county_id+"',district_id='"+district_id+"',indicator_id='"+indicator_id+"',year='"+year+"'"
           + ", target_combined='"+target_combined+"',target_men='"+target_men+"', target_women='"+target_women+"',quarter='"+quarter+"',table_type='"+table_type+"'";  
       conn.state1.executeUpdate(inserter);   
        ...
        response.sendRedirect("set_quartely_target.jsp");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(add_quartely_targets.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
