 ...
 * @author Maureen
 */
public class UpdateResult2 extends HttpServlet {
...
System.out.println("cols "+columnPosition);
...
//  String unique=(String)session.getAttribute("countyid");
	dbConnect conn = new dbConnect();
 	...
 	// update the table with the value that was edited from the form
        if(CID == 3){
	 query1 = "update indicatorachievedcombined set totalAchieved='"+value+"' where resultID='"+id+"'";
...
//           out.println("Saved, Refresh page");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateResult2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
