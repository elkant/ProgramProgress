...
//    System.out.println("^^^^^^^^^"+overall_district_counter_prev);
   ...
   String prev_selector="SELECT SUM(totalAchieved) FROM indicatorachievedcombined WHERE (County='"+county_name+"'|| County='"+county_id+"') && financialYear='"+year+"' && reportingPeriod='Q1' && titleID='"+indicator_id+"'";
...
//             String cust_q="Q"+previous_quarter;
              ...
              String count_dist_prev="SELECT count(resultID) FROM indicatorachievedcombined WHERE (County='"+county_name+"'|| County='"+county_id+"') && financialYear='"+year+"' &&  reportingPeriod = 'Q2' && titleID='"+indicator_id+"'";  
 conn.rs2=conn.state2.executeQuery(count_dist_prev);
...
//    System.out.println("^^^^^^^^^"+overall_district_counter_prev);
   ...
   String prev_selector="SELECT SUM(totalAchieved) FROM indicatorachievedcombined WHERE (County='"+county_name+"'|| County='"+county_id+"') && financialYear='"+year+"' && reportingPeriod='Q2' && titleID='"+indicator_id+"'";
  conn.rs1=conn.state1.executeQuery(prev_selector);
  if(conn.rs1.next()==true){
    previous_quarter_achieved=conn.rs1.getInt(1);
    previous_quarter_achieved_total+= previous_quarter_achieved;
...
//     sheet 3
     ...
     rw8cell8_3.setCellValue("");
      ...
      if(district_counter_prev>0){
            ...
            rw8cell4_3.setCellValue(previous_quarter_achieved/district_counter_prev+"%");    
      }
      if(district_counter_prev==0){
       rw8cell4.setCellValue("");
       rw8cell4_3.setCellValue("");
...
//     rw9cell8_3.setCellValue(achieved_this_year_total);
      ...
      if(indicator_id.equals("5")||indicator_id.equals("7")||indicator_id.equals("9")||indicator_id.equals("16")||indicator_id.equals("20")||indicator_id.equals("22")||
          ...
          rw9cell8_3.setCellValue(achieved_this_period_total);
           ...
           else{     rw9cell8_3.setCellValue(achieved_this_year_total);
       } 
     }
     if (percents==1){
...
//     rw8cell15.setCellValue(achieved_this_year_m);
   ...
   if (percentages==1){
     ...
     rw8cell10_3.setCellValue((achieved_this_period_f/district_counter)+"%");
     rw8cell11_3.setCellValue((achieved_this_period_m/district_counter)+"%");
...
//     rwkcell5.setCellValue(achieved_prior_total_m);
     ...
     //sheet3
     rwkcell10_3.setCellValue((achieved_this_period_total_f/district_counter_yr1)+"%");
     rwkcell11_3.setCellValue((achieved_this_period_total_m/district_counter_yr1)+"%");
     rwkcell12_3.setCellValue("");
     rwkcell13_3.setCellValue("");
     rwkcell14_3.setCellValue((achieved_this_year_total_f/district_counter_yr1)+"%");
     rwkcell15_3.setCellValue((achieved_this_year_total_m/district_counter_yr1)+"%");
        }
               //    }     
     ...
     //sheet3
     rwkcell10_3.setCellValue((achieved_this_period_total_f/overall_districts)+"%");
     rwkcell11_3.setCellValue((achieved_this_period_total_m/overall_districts)+"%");
     rwkcell12_3.setCellValue("");
     rwkcell13_3.setCellValue("");
     rwkcell14_3.setCellValue((achieved_this_year_total_f/overall_districts_yr)+"%");
     rwkcell15_3.setCellValue((achieved_this_year_total_m/overall_districts_yr)+"%");
               } }
...
response.setHeader("Content-Disposition", "attachment; filename=PPMT_"+period+"_"+Display_year+"_"+"County_Report_Created_On_"+current_time+".xls");
