...
//            System.out.println(" last cell no = "+lastCellNo);
            ...
            for (int i = 0; i < lastCellNo; i++) {
                ...
                Cell cell5 = rowi.getCell((short) 5);//youths using fp
                id3 = (int) cell5.getNumericCellValue();
                
                
                Cell cell6 = rowi.getCell((short) 6);// 15-24
                id4 = (int) cell6.getNumericCellValue();
                
                
                Cell cell7 = rowi.getCell((short) 7); //dpt 34
                id5 = (int) cell7.getNumericCellValue();
                Cell cell8 = rowi.getCell((short) 8); //dpt
                id6 = (int) cell8.getNumericCellValue();
                
                Cell cell9 = rowi.getCell((short) 9); //pneumonia  35
                id7 = (int) cell9.getNumericCellValue();
                Cell cell10 = rowi.getCell((short) 10);
                id8 = (int) cell10.getNumericCellValue();
                
                Cell cell11 = rowi.getCell((short) 11);// vitamin a
            ...
            System.out.println("id8 :" + id8 + "id9 :" + id9 + "id10 :" + id10 + "id11 :" + id11);
         
            if (id1 >-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='3'and reportingPeriod='" + quarter + "'";
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id1 + "','" + quarter + "','" + year + "','3')";
//                              conn.state.executeUpdate(query);
            ...
            if (id2 >-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where district='" + district + "' and financialYear='" + year + "' and titleID='27' and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id2 + "','" + quarter + "','" + year + "','27')";
//                              conn.state.executeUpdate(query);
                }
                try {
                    conn.state.executeUpdate(query);
            ...
            if (id3>-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='29'  and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id3 + "','" + quarter + "','" + year + "','29')";
                }
...
//                              conn.state.executeUpdate(query);
             ...
             if (id4>-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='41'  and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id4 + "','" + quarter + "','" + year + "','41')";
                }
...
//                String query = "";
//                String checkexistingval = "Select * from indicatorachievedCOBIN where  district='" + district + "' and financialYear='" + year + "' and titleID='41' and reportingPeriod='" + quarter + "'";
//                conn.rs3 = conn.state3.executeQuery(checkexistingval);
//
//                if (conn.rs3.next()) {
//                    query = "update indicatorachieved set menAchieved='" + id4 + "',womenAchieved='" + id5 + "' where resultID='" + conn.rs3.getString(1) + "'";
//
//                } else {
...
//                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id4 + "','" + id5 + "','" + quarter + "','" + year + "','41')";
//                }
//                try {
//                    conn.state.executeUpdate(query);
//                    replyback = "<font color=\"orange\"><b>Importing completed ";
...
//check whether there is an existing record then do an update                              
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachieved(resultID,county,district,menAchieved,womenAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id5 + "','" + id6 + "','" + quarter + "','" + year + "','34')";
                }
                try {
                    conn.state.executeUpdate(query);
                    replyback = "<font color=\"orange\"><b>Importing completed ";
...
//check whether there is an existing record then do an update                              
                String query = "";
                String checkexistingval = "Select * from indicatorachieved where  district='" + district + "' and financialYear='" + year + "' and titleID='35' and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachieved(resultID,county,district,menAchieved,womenAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id7 + "','" + id8 + "','" + quarter + "','" + year + "','35')";
                }
                try {
                    conn.state.executeUpdate(query);
                    replyback = "<font color=\"orange\"><b>Importing completed ";
...
//check whether there is an existing record then do an update                              
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachieved(resultID,county,district,menAchieved,womenAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id9 + "','" + id10 + "','" + quarter + "','" + year + "','33')";
                }
                try {
                    conn.state.executeUpdate(query);
                    replyback = "<font color=\"orange\"><b>Importing completed ";
