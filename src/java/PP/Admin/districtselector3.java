 ...
 * @author Maureen
 */
public class districtselector3 extends HttpServlet {
...
//          dist.add(conn.rs.getString("DistrictName")); 
          ...
          current_districts1=current_districts1+"<option value=\""+conn.rs.getString("DistrictName")+"\">"+conn.rs.getString("DistrictName")+"</option>";
//        session.setAttribute("dist_names",dist);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(districtselector2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
