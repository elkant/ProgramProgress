...
//           filter="select * from baseline where FinancialYear='"+financial+"' AND Quarter='"+quarter+"' and District='"+district+"'";
...
////                                        System.out.println("Disconnected from database");
            ...
            Logger.getLogger(PP.Admin.filterer.class.getName()).log(Level.SEVERE, null, ex);
        }
