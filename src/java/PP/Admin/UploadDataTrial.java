 ...
 * @author Maureen
 */
public class UploadDataTrial extends HttpServlet {
...
//        String pth = mydrive + ":/PPT_UPLOADS/" + itemName;
 ...
 String pth = "C:/PPT_UPLOADS/PPTDATA.xlsx";
      ...
      //  Sheet sheet = wb.getSheetAt(0);
        Sheet sheet = wb.getSheet("NonHIV");
...
//check whether there is an existing record then do an update                              
                String query = "";
                String checkexistingval = "Select * from indicatorachieved where  district='" + district + "' and financialYear='" + year + "' and titleID='8' and reportingPeriod='" + quarter + "'";
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachieved(resultID,county,district,menAchieved,womenAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id1 + "','" + id2 + "','" + quarter + "','" + year + "','8')";
                }
                try {
            ...
            if (id3 >-1) {
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id3 + "','" + quarter + "','" + year + "','10')";
//                              conn.state.executeUpdate(query);
                }//end of else
                System.out.println(query);
                try {
            ...
            if (id4 >-1) {
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id4 + "','" + quarter + "','" + year + "','11')";
//                              conn.state.executeUpdate(query);
                }
                try {
                    conn.state.executeUpdate(query);
            ...
            if (id5>-1) {
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id5 + "','" + quarter + "','" + year + "','30')";
                }
...
//                              conn.state.executeUpdate(query);
            ...
            if (id6>-1) {
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id6 + "','" + quarter + "','" + year + "','31')";
                }
                try {
                    conn.state.executeUpdate(query);
                    replyback = "<font color=\"orange\"><b>Importing completed ";
...
//                              conn.state.executeUpdate(query);
            ...
            if (id7>-1) {
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id7 + "','" + quarter + "','" + year + "','32')";
//                              conn.state.executeUpdate(query);
