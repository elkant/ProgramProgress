...
//System.out.println("Computer name "+computername);
        ...
        String pth = "C:/PPT_UPLOADS/OVC_ALLYEAR.xls";
...
//            System.out.println(" last cell no = "+lastCellNo);
            ...
            if (id1 > -1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined_ovc_pepfar where district='" + district + "' and financialYear='" + year + "' and titleID='47' and reportingPeriod='" + quarter + "' ";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);

                if (conn.rs3.next()) {
                    query = "update indicatorachievedcombined_ovc_pepfar set totalAchieved='" + id1 + "' where resultID='" + conn.rs3.getString(1) + "'";
            ...
            if (id2 > -1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined_ovc_pepfar where district='" + district + "' and financialYear='" + year + "' and titleID='49' and reportingPeriod='" + quarter + "' ";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);

                if (conn.rs3.next()) {
                    query = "update indicatorachievedcombined_ovc_pepfar set totalAchieved='" + id2 + "' where resultID='" + conn.rs3.getString(1) + "'";
            ...
            if (id3 > -1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined_ovc_pepfar where district='" + district + "' and financialYear='" + year + "' and titleID='46' and reportingPeriod='" + quarter + "' ";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);

                if (conn.rs3.next()) {
                    query = "update indicatorachievedcombined_ovc_pepfar set totalAchieved='" + id3 + "' where resultID='" + conn.rs3.getString(1) + "'";
             ...
             if (id4 > -1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined_ovc_pepfar where district='" + district + "' and financialYear='" + year + "' and titleID='55' and reportingPeriod='" + quarter + "' ";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);

                if (conn.rs3.next()) {
                    query = "update indicatorachievedcombined_ovc_pepfar set totalAchieved='" + id4 + "' where resultID='" + conn.rs3.getString(1) + "'";
              ...
              if (id5 > -1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined_ovc_pepfar where district='" + district + "' and financialYear='" + year + "' and titleID='153' and reportingPeriod='" + quarter + "' ";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);

                if (conn.rs3.next()) {
                    query = "update indicatorachievedcombined_ovc_pepfar set totalAchieved='" + id5 + "' where resultID='" + conn.rs3.getString(1) + "'";
              ...
              if (id6 > -1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined_ovc_pepfar where district='" + district + "' and financialYear='" + year + "' and titleID='53' and reportingPeriod='" + quarter + "' ";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);

                if (conn.rs3.next()) {
                    query = "update indicatorachievedcombined_ovc_pepfar set totalAchieved='" + id6 + "' where resultID='" + conn.rs3.getString(1) + "'";
              ...
              if (id7 > -1) {
//                String query = "";
//                String checkexistingval = "Select * from indicatorachievedcombined_ovc_pepfar where district='" + district + "' and financialYear='" + year + "' and titleID='54' and reportingPeriod='" + quarter + "' ";
//                conn.rs3 = conn.state3.executeQuery(checkexistingval);
//
//                if (conn.rs3.next()) {
//                    query = "update indicatorachievedcombined_ovc_pepfar set totalAchieved='" + id7 + "' where resultID='" + conn.rs3.getString(1) + "'";
//
//                } else {
//                    query = "insert into indicatorachievedcombined_ovc_pepfar(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
...
//                }
   String query = "";
                String checkexistingval = "Select * from indicatorachieved_ovc_pepfar where district='" + district + "' and financialYear='" + year + "' and titleID='54' and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);

                if (conn.rs3.next()) {
                    query = "update indicatorachieved_ovc_pepfar set menAchieved='" + id7 + "',womenAchieved='" + id8 + "' where resultID='" + conn.rs3.getString(1) + "'";
