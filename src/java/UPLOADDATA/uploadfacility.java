...
//        String pth = mydrive + ":/PPT_UPLOADS/" + itemName;
  String pth = "C:/PPT_UPLOADS/TemplateData.xlsx";
      ...
      //  Sheet sheet = wb.getSheetAt(0);
        Sheet sheet = wb.getSheet("QryNonHIV3");
...
//                id8 = (int) cell10.getNumericCellValue();
                Cell cell11 = rowi.getCell((short) 10);
...
//            }
            if (id4>-1) {
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id4 + "','" + quarter + "','" + year + "','13')";
                }
                try {
                    conn.state.executeUpdate(query);
                    replyback = "<font color=\"orange\"><b>Importing completed ";
...
//                              conn.state.executeUpdate(query);
            ...
            if (id5>-1) {
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id5 + "','" + quarter + "','" + year + "','16')";
                }
                try {
                    conn.state.executeUpdate(query);
                    replyback = "<font color=\"orange\"><b>Importing completed ";
...
//                              conn.state.executeUpdate(query);
            ...
            if (id6>-1) {
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id6 + "','" + quarter + "','" + year + "','26')";
//                              conn.state.executeUpdate(query);
            ...
            if (id7>-1) {
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id7 + "','" + quarter + "','" + year + "','57')";
//                              conn.state.executeUpdate(query);
