 ...
 * @author Maureen
 */
public class UploadNonHIV2 extends HttpServlet {
...
// FOR NON HIV MODULE BOOK4 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int id1 = 0, id2 = 0, id3 = 0, id4 = 0, id5 = 0, id6 = 0, id7 = 0, year = 0;
...
//        String pth = mydrive + ":/PPT_UPLOADS/" + itemName;
 ...
 String pth = "C:/PPT_UPLOADS/PPTDATAQ2.xlsx";
      ...
      //  Sheet sheet = wb.getSheetAt(0);
        Sheet sheet = wb.getSheet("QryNonHIV2");
...
//            System.out.println(" last cell no = "+lastCellNo);
            ...
            for (int i = 0; i < lastCellNo; i++) {
                ...
                year = (int) cell10.getNumericCellValue();
            ...
            if (id1 >-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='10'and reportingPeriod='" + quarter + "'";
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id1 + "','" + quarter + "','" + year + "','10')";
//                              conn.state.executeUpdate(query);
            ...
            if (id2 >-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='11'and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id2 + "','" + quarter + "','" + year + "','11')";
//                              conn.state.executeUpdate(query);
                }//end of else
                System.out.println(query);
                try {
            ...
            if (id3 >-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='12'and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id3 + "','" + quarter + "','" + year + "','12')";
//                              conn.state.executeUpdate(query);
                }//end of else
                System.out.println(query);
                try {
            ...
            if (id4 >-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where district='" + district + "' and financialYear='" + year + "' and titleID='30' and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id4 + "','" + quarter + "','" + year + "','30')";
//                              conn.state.executeUpdate(query);
                }
                try {
                    conn.state.executeUpdate(query);
            ...
            if (id5>-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='31'  and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id5 + "','" + quarter + "','" + year + "','31')";
                }
...
//                              conn.state.executeUpdate(query);
            ...
            if (id6>-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='32'  and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id6 + "','" + quarter + "','" + year + "','32')";
                }
                try {
                    conn.state.executeUpdate(query);
                    replyback = "<font color=\"orange\"><b>Importing completed ";
...
//                              conn.state.executeUpdate(query);
            ...
            if (id7>-1) {
                String query = "";
                String checkexistingval = "Select * from indicatorachievedcombined where  district='" + district + "' and financialYear='" + year + "' and titleID='14'  and reportingPeriod='" + quarter + "'";
                conn.rs3 = conn.state3.executeQuery(checkexistingval);
                ...
                if (conn.rs3.next()) {
                    ...
                    query = "insert into indicatorachievedcombined(resultID,county,district,totalAchieved,reportingPeriod,financialYear,titleID)"
                            + "VALUES('"+uniqueid().trim()+"','" + county + "','" + district + "','" + id7 + "','" + quarter + "','" + year + "','14')";
//                              conn.state.executeUpdate(query);
