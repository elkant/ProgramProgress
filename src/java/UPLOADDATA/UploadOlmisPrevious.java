 ...
 * @author Maureen
 */
public class UploadOlmisPrevious extends HttpServlet {
...
//System.out.println("Computer name "+computername);
        ...
        String pth = "C:/PPT_UPLOADS/OVCLAST.xlsx";
       ...
       // Sheet sheet = wb.getSheetAt(0);
        Sheet sheet = wb.getSheet("oct-june");
...
//                id6 = (int) cell8.getNumericCellValue();
                ...
                Cell cell9 = rowi.getCell((short) 3);
                id7 = (int) cell9.getNumericCellValue();
                
                Cell cell10 = rowi.getCell((short) 4);
                id8 = (int) cell10.getNumericCellValue();
                
              
                
                Cell cell14 = rowi.getCell((short) 5);
